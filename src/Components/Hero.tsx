        ...
        <div className='bg-white text-gray-600'>
            <div className="container flex items-center mx-auto py-10">
                <div className="hero-text">
                    <h2 className="text-5xl font-bold mb-4">Build Your Ideal <br /> <span className="text-4xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Development Stack</span></h2>
                    ...
                    <button className="btn btn-secondary text-[14px] rounded-1xl px-4 mr-3 bg-linear-65 from-purple-500 to-pink-500">Explore Technologies</button>
