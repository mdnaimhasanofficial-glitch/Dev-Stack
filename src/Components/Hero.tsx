        ...
        <div className='bg-white text-gray-600'>
            <div className="container flex mx-auto py-10">
                <div className="hero-text">
                    <h2 className="text-5xl font-bold mb-4">Build Your Ideal <br /> <span className="text-[#F43098]">Development Stack</span></h2>
                    ...
                    <button className="btn btn-secondary text-[14px] rounded-1xl px-4 mr-3">Explore Technologies</button>
